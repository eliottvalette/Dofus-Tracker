...
export default function Home() {
  ...
  useEffect(() => {
    filterItems();
  }, [allItems, searchTerm, selectedType, selectedCategory]);
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Statistiques générales et vue d'ensemble de vos activités
        </p>
      </div>
            ...
            >
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {loading ? "..." : allItems.filter(item => item.category === category.id).length}
                </div>
